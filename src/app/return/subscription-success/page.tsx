    ...
    <div className="marketing-shell">
      ...
      <div className="container mx-auto px-4 pt-28 pb-20">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-800 mb-2">Your subscription is active.</p>
          ...
          {sessionId && (
            <div className="mt-12 p-4 bg-white/5 border border-primary/20 rounded-xl text-left">
              <p className="text-sm text-slate-500 mb-2">Opening the app?</p>
              <a
...
export default function SubscriptionSuccessPage() {
  return (
    <Suspense fallback={<div className="marketing-shell pt-28 flex justify-center text-slate-500">Loading…</div>}>
