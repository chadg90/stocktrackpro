...
export default function PlantPricingCard({
  ...
  return (
    <div className="relative bg-white backdrop-blur-sm rounded-3xl p-8 sm:p-10 border border-amber-500/50 shadow-2xl shadow-amber-500/15 ring-2 ring-amber-500/20">
        ...
        >
          <button
            ...
            className={`px-4 py-1.5 text-sm font-semibold rounded-full transition-all ${
              billingCycle === 'monthly' ? 'bg-amber-500 text-black shadow' : 'text-slate-500 hover:text-slate-700'
            }`}
          >
            Monthly
          </button>
          <button
            ...
            className={`px-4 py-1.5 text-sm font-semibold rounded-full transition-all inline-flex items-center gap-1.5 ${
              billingCycle === 'yearly' ? 'bg-amber-500 text-black shadow' : 'text-slate-500 hover:text-slate-700'
            }`}
          >
            Annual
            <span
      ...
      <div className="text-center mb-8">
        <div className="flex items-end justify-center gap-1 mb-1">
          <span className="text-5xl sm:text-6xl font-bold text-slate-900">£{billedTotal}</span>
          <span className="text-slate-500 text-lg mb-2">
      ...
      <div className="mb-8">
        <div className="flex justify-between text-sm text-slate-500 mb-3">
          <span>Machines</span>
          <span className="text-slate-900 font-semibold">{machineCount}</span>
        </div>
        <input
          type="range"
          ...
          className="w-full h-3 rounded-full appearance-none cursor-pointer accent-amber-500 [&::-webkit-slider-runnable-track]:h-3 [&::-webkit-slider-runnable-track]:rounded-full [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:relative [&::-webkit-slider-thumb]:-mt-0.5 [&::-webkit-slider-thumb]:h-6 [&::-webkit-slider-thumb]:w-6 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-amber-500 [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white [&::-webkit-slider-thumb]:shadow-[0_1px_4px_rgba(15,23,42,0.35)] [&::-webkit-slider-thumb]:cursor-pointer [&::-moz-range-track]:h-3 [&::-moz-range-track]:rounded-full [&::-moz-range-thumb]:h-6 [&::-moz-range-thumb]:w-6 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-amber-500 [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-white [&::-moz-range-thumb]:box-border"
          style={{
            background: `linear-gradient(to right, #f59e0b 0%, #f59e0b ${sliderPct}%, #cbd5e1 ${sliderPct}%, #cbd5e1 100%)`,
          }}
      ...
      <div className="mt-8 pt-8 border-t border-slate-200">
        <p className="text-slate-500 text-sm font-medium mb-4">Included:</p>
