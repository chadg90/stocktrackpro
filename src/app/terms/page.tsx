        ...
        <div className="max-w-4xl mx-auto pt-20">
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-zinc-300 mb-8">
              ...
              and{' '}
              <Link href="/subscription-terms" className="text-[var(--brand-blue)] hover:text-blue-700">
                Subscription Terms
              </Link>
            ...
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">3. User Accounts and Security</h2>
            <p className="text-zinc-300 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">4. Subscription and Payments</h2>
            <p className="text-zinc-300 mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">6. Acceptable Use</h2>
            <p className="text-zinc-300 mb-4">
            ...
            <ul className="list-none text-zinc-300 mb-8">
              ...
              <li>
                Website:{' '}
                <a href="https://www.fleettrackpro.co.uk" className="text-[var(--brand-blue)] hover:text-blue-700">
