    ...
    <div className="marketing-shell">
      ...
      <div className="container mx-auto px-4 pt-32 pb-20">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-600 mb-8">Last Updated: 12 May 2026</p>
            ...
            <div className="bg-white border border-primary/20 rounded-2xl p-8">
              ...
              <ul className="space-y-3 text-slate-600">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-slate-900 font-semibold">Essential Cookies</p>
                ...
                <li className="flex items-start gap-3">
                  <span className="mt-2 h-2 w-2 rounded-full bg-primary"></span>
                  <div>
                    <p className="text-slate-900 font-semibold">Analytics Cookies</p>
                ...
                <li className="flex items-start gap-3">
                  <span className="mt-2 h-2 w-2 rounded-full bg-primary"></span>
                  <div>
                    <p className="text-slate-900 font-semibold">Preference Cookies</p>
