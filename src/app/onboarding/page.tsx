        ...
        {step === 'choice' ? (
          <div className="dashboard-card p-8 shadow-xl space-y-6">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                href="/dashboard"
                className="flex-1 p-6 rounded-xl border-2 border-slate-300 bg-white/5 hover:border-blue-400 hover:bg-slate-100 transition-colors text-left group flex flex-col"
              >
                <LogIn className="h-8 w-8 text-blue-500 mb-4 group-hover:scale-110 transition-transform" />
                <h3 className="font-semibold text-slate-900 text-lg mb-2">Sign in</h3>
                <p className="text-slate-500 text-sm">
          ...
          <div className="dashboard-card p-8 shadow-xl space-y-6">
            <div className="flex items-center gap-3 p-4 rounded-xl bg-blue-500/10 border border-slate-200">
              <CheckCircle className="w-8 h-8 text-blue-500 flex-shrink-0" />
              <div>
                <p className="font-semibold text-slate-900">{createdCompanyName}</p>
                <p className="text-slate-500 text-sm">
            ...
            <div>
              <p className="text-slate-600 text-sm font-medium mb-3">Your next four steps:</p>
              <ol className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3">
                    <div className="w-7 h-7 rounded-lg bg-blue-500/15 text-[var(--brand-blue)] flex items-center justify-center flex-shrink-0 mt-0.5 font-semibold text-sm">
                      {i + 1}
                    </div>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 space-y-3">
              <p className="text-slate-600 text-sm font-medium flex items-center gap-2">
                <Smartphone className="w-4 h-4 text-[var(--brand-blue)]" />
                Get the mobile app
              </p>
            ...
            <p className="text-slate-400 text-xs text-center">
              ...
              <Link href="/dashboard/subscription" className="text-[var(--brand-blue)] hover:underline">
        ...
        <div className="dashboard-card p-8 shadow-xl">
          {step === 'account' ? (
            <form onSubmit={handleAccountCreation} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full text-white font-semibold rounded-lg py-2.5 transition-colors disabled:opacity-60 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-50 flex items-center justify-center gap-2 btn-brand-blue"
                disabled={loading}
              >
                {loading ? (
                  <>
            ...
            <div className="space-y-6">
              <form onSubmit={handleCreateCompany} className="space-y-5">
                  ...
                  <div className="rounded-lg border border-slate-200 bg-blue-500/5 p-4 space-y-3">
                    <div className="flex items-start gap-3">
                      <CreditCard className="w-4 h-4 text-[var(--brand-blue)] flex-shrink-0 mt-0.5" />
                      <div className="text-sm text-slate-600">
                        ...
                        <p className="text-slate-500 text-xs leading-relaxed">
                          ...
                          Minimum 2 vehicles. Cancel anytime on monthly plans.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <button
                type="button"
                onClick={() => setStep('account')}
                className="w-full text-slate-500 hover:text-slate-900 text-sm transition-colors"
              >
