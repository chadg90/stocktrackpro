...
export const metadata: Metadata = {
  title: 'FAQ',
  description:
    'Common questions about Fleet Track PRO — fleet compliance, user allowances, UK-wide coverage, vehicles supported, and contracts.',
  alternates: { canonical: '/faq' },
  openGraph: {
    title: 'FAQ | Fleet Track PRO',
    description:
      'Answers on fleet compliance software use, user allowances, fleet types, UK coverage, and cancellation.',
  ...
  return (
    <>
      <MarketingWebPageJsonLd
        path="/faq"
        title="FAQ"
        description="Frequently asked questions about Fleet Track PRO fleet management software, pricing, and setup."
      />
      {children}
    </>
  );
