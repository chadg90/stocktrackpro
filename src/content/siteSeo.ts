...
export const SITE_KNOWS_ABOUT = [
  ...
  'Plant and machinery compliance',
];

export const SOFTWARE_FEATURE_LIST = [
  'Daily van walkaround inspections with required photos',
  ...
  'Optional Plant & Machinery module — multiple forms per inspection entry',
];
